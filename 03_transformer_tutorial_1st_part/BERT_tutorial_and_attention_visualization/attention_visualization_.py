...
class Pretrainer:
    ...
    def load_model(self, model, dir_path="./output"):
        ...
        checkpoint['model_state_dict'] = {k[5:]:v for k,v in checkpoint_dir['model_state_dict'].items() if k[:4] == 'bert'}
    ...
    def __call__(self,text_list,batch_size=1):
        ...
        # 正向
        n_batches = math.ceil((texts_tokens) / batch_size) # 向上取整math.ceil   向下取整math.floor
